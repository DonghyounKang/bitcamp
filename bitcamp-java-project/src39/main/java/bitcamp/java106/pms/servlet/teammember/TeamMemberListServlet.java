...
public class TeamMemberListServlet extends HttpServlet {
    ...
    protected void doGet(
        ...
        //include하기 전에  이전 servlet에서 charset을 지정할 것이고 
        ...
        //include하기 전에  이전 servlet에서 contentType을 지정할 것이기 때문에  다음 코드는 의미가 없다.
        //response.setContentType("text/html;charset=UTF-8");
        
        PrintWriter out = response.getWriter();
        
        //이전 servlet에서 먼저 출력한 부분은 제외한다. ==> 포함시킬 내용은 팀회원 목록만 출력
        try {
