// 다형성 - 다형적 변수(polymorphic variables)와 형변환
package step11.ex09;
...
public class Exam02 {
    public static void main(String[] args) {
        ...
        //자바 컴파일러는 레퍼런스의 클래스를 보고사용할 수있는 변수나 메서드인지 아닌지 판단한다.
        //비록 v1변수에 Sedan 객체의 주소가 들어있다 할지라도
        //실제 들어있는 객체의 주소로 판단하지 않고 레퍼런스가 어떤 클래스인지에 따라 판단한다. 
        /*
        v1.cc = 1980;//컴파일 오류
        v1.valve = 16;//컴파일 오류
