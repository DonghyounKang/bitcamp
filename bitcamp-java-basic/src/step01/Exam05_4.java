//정수의 리터럴 II - 메모리에 저장하는 방법
package step01;
public class Exam05_4{
    public static void main(String[] args) {


        System.out.println(5 + (-3));//4바이트 양의 정수 최대값
        System.out.println(5 - 3);//4바이트 양의 정수 최소값
...
//결론
//자바에서는 정수 저장시 2의 보수방식
// => 부동 소수점을 저장시
//    가수부 'Sign-Magnitude'방식으로 저장
//    진수부 'Excess-K'방식으로 저장
