...
public class Exam01_2 {
    //
    // 클래스 안에 정의된 클래스를 "중첩클래스(nested class)"라고 한다.
    // -특정 클래스 안에서만 사용될 클래스-
    // => 해당 클래스 내부에 선언함으로써 유지보수를 편리하게 만든다.
    // => 패키지 멤버 클래스로 선언하면 같은 이름으로 패키지 멤버를 중복해서 만들 수 없지만
    //    클래스 안에 선언하는 경우, 같은 이름으로 자신만의 기능을 수행하는 중첩 클래스를 
    //    여러 클래스 안에 만들 수 있다.
    ...
    public static void main(String[] args) throws Exception{
        ...
        //스테틱 중첩 클래스의 인스턴스를 필터로 사용하여 디렉토리 안의 목록 추출
