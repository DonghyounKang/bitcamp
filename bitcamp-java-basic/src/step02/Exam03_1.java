...
-정수
    - byte : 1byte메모리(-128~127)
    - short : 2byte메모리(32768~32767)
    - int : 4byte메모리(약 -21억~21억)
    - long : 8byte메모리(-922경~922경)
-부동소수점
    - float : 4byte메모리(유효자리수 7자리)
    - double : 8byte메모리(유효자리수 15자리)

-문자
    - char : 2byte 메모리(0~65535). UTF-16코드 값 저장
-논리값
